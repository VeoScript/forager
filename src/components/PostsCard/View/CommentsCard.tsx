...
const CommentsCard: React.FC<TypeProps> = ({ host, dishes }) => {
  ...
  return (
    <div className="flex flex-col w-full border border-black-matt border-opacity-10 bg-pure-white">
      <div className="flex flex-row items-center justify-between w-full p-3 border-b border-black-matt border-opacity-10">
      ...
      >
        {dish.comments.map((comment: any, i: number) => (
          <div className="flex flex-row items-center justify-between w-full p-3 border-b border-black-matt border-opacity-10" key={i}>
